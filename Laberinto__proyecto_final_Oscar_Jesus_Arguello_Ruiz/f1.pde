class Limitef1{
  ...
  Limitef1( float x_, float y_, float w_, float h_){
    w = w_;
    h = h_;
    x = x_;
    y = y_;
...
class Limitef2{
  ...
  Limitef2( float x_, float y_, float w_, float h_){
    w = w_;
    h = h_;
    x = x_;
    y = y_;
...
class Limitef3{
  ...
  Limitef3( float x_, float y_, float w_, float h_){
    w = w_;
    h = h_;
    x = x_;
    y = y_;
...
class Limitef4{
  ...
  Limitef4( float x_, float y_, float w_, float h_){
    w = w_;
    h = h_;
    x = x_;
    y = y_;
