class Limiteg1{
  ...
  Limiteg1( float x_, float y_, float w_, float h_){
    w = w_;
    h = h_;
    x = x_;
    y = y_;
...
class Limiteg2{
  ...
  Limiteg2( float x_, float y_, float w_, float h_){
    w = w_;
    h = h_;
    x = x_;
    y = y_;
...
class Limiteg3{
  ...
  Limiteg3( float x_, float y_, float w_, float h_){
    w = w_;
    h = h_;
    x = x_;
    y = y_;
...
class Limiteg4{
  ...
  Limiteg4( float x_, float y_, float w_, float h_){
    w = w_;
    h = h_;
    x = x_;
    y = y_;
